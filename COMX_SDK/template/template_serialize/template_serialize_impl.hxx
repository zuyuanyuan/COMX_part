/*HEAD template_serialize_impl HXX COMX_COMPONENT_MODULE */
...
#ifndef _KMAS_COMX_TEMPLATE_SERIALIZE_IMPL_H_2009101535947
#define _KMAS_COMX_TEMPLATE_SERIALIZE_IMPL_H_2009101535947
...
class TTemplateSerializeImpl
{
protected:
  TTemplateSerializeImpl();
  ~TTemplateSerializeImpl(){}
protected:
  bool impl_OnOpen();
  bool impl_OnSave();
...
template<typename TOwner>
TTemplateSerializeImpl<TOwner>::TTemplateSerializeImpl()
{
...
template<typename TOwner>
bool TTemplateSerializeImpl<TOwner>::impl_OnOpen()
{
...
template<typename TOwner>
bool TTemplateSerializeImpl<TOwner>::impl_OnSave()
{
  TOwner *pOwner = static_cast<TOwner*>(this);
  bool ret = false;
...
template<typename TOwner>
bool TTemplateSerializeImpl<TOwner>::impl_OnPrint()
{
  TOwner *pOwner = static_cast<TOwner*>(this);
  bool ret = false;
...
template<typename TOwner>
bool TTemplateSerializeImpl<TOwner>::is_nastran_file(const char *fname)
{
  TOwner *pOwner = static_cast<TOwner*>(this);
  bool ret = false;
...
template<typename TOwner>
bool TTemplateSerializeImpl<TOwner>::is_step_file(const char *fname)
{
  TOwner *pOwner = static_cast<TOwner*>(this);
  bool ret = false;
...
template<typename TOwner>
bool TTemplateSerializeImpl<TOwner>::is_iges_file(const char *fname)
{
  TOwner *pOwner = static_cast<TOwner*>(this);
  bool ret = false;
...
template<typename TOwner>
bool TTemplateSerializeImpl<TOwner>::is_acis_file(const char *fname)
{
  TOwner *pOwner = static_cast<TOwner*>(this);
  bool ret = false;
...
template<typename TOwner>
bool TTemplateSerializeImpl<TOwner>::is_have_data()
{
  TOwner *pOwner = static_cast<TOwner*>(this);
  bool ret = false;
...
template<typename TOwner>
bool TTemplateSerializeImpl<TOwner>::clear_current_data()
{
  TOwner *pOwner = static_cast<TOwner*>(this);
  bool ret = false;
...
template<typename TOwner>
bool TTemplateSerializeImpl<TOwner>::clear_fem_data()
{
  TOwner *pOwner = static_cast<TOwner*>(this);
  bool ret = false;
...
template<typename TOwner>
bool TTemplateSerializeImpl<TOwner>::clear_cad_data()
{
  TOwner *pOwner = static_cast<TOwner*>(this);
  bool ret = false;
...
template<typename TOwner>
bool TTemplateSerializeImpl<TOwner>::is_have_fem_data()
{
  TOwner *pOwner = static_cast<TOwner*>(this);
  bool ret = false;
...
template<typename TOwner>
bool TTemplateSerializeImpl<TOwner>::is_have_cad_data()
{
  TOwner *pOwner = static_cast<TOwner*>(this);
  bool ret = false;
...
template<typename TOwner>
bool TTemplateSerializeImpl<TOwner>::is_continue()
{
  TOwner *pOwner = static_cast<TOwner*>(this);
  bool ret = false;
...
template<typename TOwner>
bool TTemplateSerializeImpl<TOwner>::load_nastran_file(const char *fname)
{
  TOwner *pOwner = static_cast<TOwner*>(this);
  bool ret = false;
...
template<typename TOwner>
bool TTemplateSerializeImpl<TOwner>::save_nastran_file(const char *fname)
{
  TOwner *pOwner = static_cast<TOwner*>(this);
  bool ret = false;
...
template<typename TOwner>
bool TTemplateSerializeImpl<TOwner>::load_step_file(const char *fname)
{
  TOwner *pOwner = static_cast<TOwner*>(this);
  bool ret = false;
...
template<typename TOwner>
bool TTemplateSerializeImpl<TOwner>::load_igs_file(const char *fname)
{
  TOwner *pOwner = static_cast<TOwner*>(this);
  bool ret = false;
...
template<typename TOwner>
bool TTemplateSerializeImpl<TOwner>::load_sat_file(const char *fname)
{
  TOwner *pOwner = static_cast<TOwner*>(this);
  bool ret = false;
...
template<typename TOwner>
bool TTemplateSerializeImpl<TOwner>::save_sat_file(const char *fname)
{
  TOwner *pOwner = static_cast<TOwner*>(this);
  bool ret = false;
...
template<typename TOwner>
bool TTemplateSerializeImpl<TOwner>::save_iges_file(const char *fname)
{
  TOwner *pOwner = static_cast<TOwner*>(this);
  bool ret = false;
...
template<typename TOwner>
bool TTemplateSerializeImpl<TOwner>::save_step_file(const char *fname)
{
  TOwner *pOwner = static_cast<TOwner*>(this);
  bool ret = false;
...
template<typename TOwner>
void TTemplateSerializeImpl<TOwner>::acis_modified_notify()
{
  TOwner *pOwner = static_cast<TOwner*>(this);
  // bool ret = false;
...
template<typename TOwner>
void TTemplateSerializeImpl<TOwner>::init_light()
{
  TOwner *pOwner = static_cast<TOwner*>(this);
  // bool ret = false;
