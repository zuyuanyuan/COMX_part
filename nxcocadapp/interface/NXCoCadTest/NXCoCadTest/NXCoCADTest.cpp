...
extern "C" DllExport void  ufusr(char *param, int *retcod, int param_len)
{
    ...
    catch(exception& ex)
    {
		...
		//if (handle)
		{
			...
			//char temp[30] = "";
			//sprintf(temp,"%d",numThreadId);
			//printf("thread %lld success start...\n", numThreadId);
			//CloseHandle(handle);
		}
	message->Show("提示",NXMessageBox::DialogTypeQuestion,"11111");	
	if (handle)
	{
		CloseHandle(handle);
	}
	message->Show("提示",NXMessageBox::DialogTypeQuestion,"44444");
    if(theNXCoCADTest != NULL)
    {
		message->Show("提示",NXMessageBox::DialogTypeQuestion,"55555");
        delete theNXCoCADTest;
        theNXCoCADTest = NULL;
        //Terminate();
    }
	message->Show("提示",NXMessageBox::DialogTypeQuestion,"666666");
}
...
DWORD WINAPI ThreadProc(LPVOID lpParameter)
{
	...
	while(1)
	{
		...
		ifstream in("C:\\Users\\Administrator\\Desktop\\vs\\readfile3\\readfile3\\test.txt"); 
		if (! in.is_open())  
		{ 
