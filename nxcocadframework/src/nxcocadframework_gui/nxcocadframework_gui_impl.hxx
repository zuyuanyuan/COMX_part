/*HEAD nxcocadframework_gui_impl HXX COMX_COMPONENT_MODULE */
...
#ifndef _KMAS_COMX_NXCOCADFRAMEWORK_GUI_IMPL_H_2009102022354
#define _KMAS_COMX_NXCOCADFRAMEWORK_GUI_IMPL_H_2009102022354
...
class TNxcocadframeworkGuiImpl
{
protected:
    TNxcocadframeworkGuiImpl(){}
    ~TNxcocadframeworkGuiImpl(){}
protected:
...
template<typename TOwner>
bool TNxcocadframeworkGuiImpl<TOwner>::impl_OnDispatch(const char* tbid, const int index)
{
