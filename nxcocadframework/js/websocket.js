...
websocket.on('OnActionFire', function(data){
	...
	else if(actionID == "CreateChem")

    {

        appendFileSync(runningLog, "Parameters:" + parameters.targetExtrude + " " + parameters.strEdge + " " + parameters.radius + " " + parameters.setName );//+ " " + parameters.length);

        websocket.Invoke('CoCADCreateChem', {'sourceID' : clientID, 'parameters' : parameters}, function(data){
	...
	else if(actionID == "CreateQiuhe")

    {

        appendFileSync(runningLog, "Parameters:" + parameters.extrude1 + " " + parameters.extrude2 + " " + parameters.setName );//+ " " + parameters.length);

        websocket.Invoke('CoCADCreateQiuhe', {'sourceID' : clientID, 'parameters' : parameters}, function(data){
